...
public class NeuralNetwork
{
    ...
    {
        weights = SaveNLoadData.LoadData<float[][][]>("Weights");
        neurons = SaveNLoadData.LoadData<float[][]>("Neurons");
    }

    public void SaveState()
    {       
        SaveNLoadData.SaveData(weights, "Weights");
        SaveNLoadData.SaveData(neurons, "Neurons");
    }
    // Return output array
